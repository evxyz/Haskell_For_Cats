...
{- 5.1 -- list comp, generators derived from set theory. 
But sets are hard to mutiliply etc. and they require uniqueness
...
corilated subqueries - 
values used in the inner loop derived from outer loop.
----- 1:57 -----------------  -----}
