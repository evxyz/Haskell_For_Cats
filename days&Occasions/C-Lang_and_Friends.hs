-- Of the set of common programming languages (as compiled by Tiobe), that are wholly or in part derived from the C programming language.
...
-- 
-- Of the set of common programming languages (as compiled by Tiobe), that are wholly or in part derived from the Lisp language.
-- list of tuples that are Char + Float
-- > let 
